                ...
                <div class="mt-2 w-2/3 border-gray-100 border-r pr-10 pb-0 border-b-0">
                    ...
                    <div class="flex items-center gap-3 mt-5">
                        <div class="flex items-center space-x-px">
                            @for($i = 0; $i<count($course->reviews); $i++)
...
{{--                            </svg>--}}
                        ...
                        <a href="#reviews" class="text-sm text-gray-500"> {{count($course->reviews)}} {{count($course->reviews) > 1 ? 'Reviews' : 'Review'}} </a>
                    </div>
                    ...
                    <div class="rounded-sm mt-8 shadow-sm bg-white">
                        <img class="w-full" src="{{$course->image}}" alt="Testing Laravel">
                        <div class="p-6">
                    ...
                    @if(!empty($course->reviews))
                        @foreach($course->reviews as $review)
                            <div class="mb-6 bg-white p-4">
                                <h4 class="font-semibold mb-2">{{$review->reviewUser->name}}</h4>
                        ...
                        <div class="space-y-4 p-6">
                            ...
                            <div class="space-y-4 pb-2">
                                <div class="aspect-w-3 aspect-h-2">
                                    <img class="object-cover w-48 m-auto shadow" src="{{$author->image}}" alt="{{$author->name}} Profile Picture">
                                </div>
